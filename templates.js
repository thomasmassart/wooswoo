app.run(['$templateCache', function($templateCache){  'use strict';
  ...
  $templateCache.put('views/directives/smart-input.html',
    "<div class=smart-input ng-click=focus()><a class=smart-input-icon><i class=\"fa fa-search\"></i></a> <a class=smart-input-erase ng-click=erase() ng-show=filled><i class=\"fa fa-times-circle\"></i></a><input class=\"smart-input-input no-shadow\" placeholder=Search></div>"
  );
