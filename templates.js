app.run(['$templateCache', function($templateCache){  'use strict';
  ...
  $templateCache.put('views/directives/smart-input.html',
    "<div class=smart-input ng-click=focus()><span class=smart-input-icon><i class=\"fa fa-search\"></i></span> <span class=smart-input-erase ng-click=erase() ng-show=isFilled()><i class=\"fa fa-times-circle\"></i></span><input class=smart-input-input ng-model=searchTextInput placeholder=Search></div>"
  );
